<template>
  <st-row class="select">
    ...
    <input autocomplete="off" readonly="readonly" ref="selectInput" @blur="inputBlur"  @click.stop="toggleMenu" :style="{ width: inputWidth }" />
...
<style lang="less" scoped>
  ...
  .select {
    ...
    .arrow {
      width: 24%;
      height: 100%;
      background: url('../../assets/img/icon-xiala.png') no-repeat 0 19px;
    }
    ul {
      position: absolute;
      top: 50px;
